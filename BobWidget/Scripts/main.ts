module bob {
    ...
    (function () {
        ...
        function createMessage(message: string, element: Element, fromUser: boolean, recognition: any) {
        ...
        function scrollToBottomOfMessages(element: Element) {
        ...
        class MessageManager {
            ...
            public SendMessage(element: Element, message: string) {
